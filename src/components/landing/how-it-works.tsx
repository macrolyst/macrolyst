const steps = [
  {
    ...
    desc: "Every morning at 1 AM CST, our pipeline fetches prices, fundamentals, news, and macro indicators for 500+ S&P 500 stocks. Technical indicators are calculated, stocks are scored, and results are ready before market open.",
    icon: "M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z",
  },
  {
    step: "02",
    title: "You explore the market",
    desc: "Real-time prices, live news, market screeners, trending tickers, ranked recommendations, technical scanners, and earnings data -- all in one dashboard. Every data point is transparent, no black box.",
    icon: "M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z M15 12a3 3 0 11-6 0 3 3 0 016 0z",
  },
  {
    step: "03",
    title: "You practice trading",
    desc: "Use paper trading with $100k simulated capital to practice your strategies. Place market orders, limit orders, and stop-losses. Track your performance over time. Learn without risking real money. This is educational, not financial advice.",
