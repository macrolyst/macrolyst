...
const navGroups = [
  {
    ...
    items: [
      ...
      { href: "/dashboard/live", label: "Current News", icon: "M13 10V3L4 14h7v7l9-11h-7z" },
      { href: "/dashboard/volume", label: "Most Active", icon: "M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" },
      { href: "/dashboard/movers", label: "Gainers & Losers", icon: "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" },
      { href: "/dashboard/shorted", label: "Most Shorted", icon: "M19 14l-7 7m0 0l-7-7m7 7V3" },
      { href: "/dashboard/undervalued", label: "Undervalued", icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" },
    ],
  },
  {
    label: "Last Trading Day Analysis",
    items: [
      { href: "/dashboard/overview", label: "Overview", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
      ...
      { href: "/dashboard/screener-builder", label: "Screener", icon: "M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/research", label: "Research", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" },
    ],
  },
];
