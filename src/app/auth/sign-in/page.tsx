    ...
    <div className="noise min-h-screen flex items-center justify-center bg-[var(--surface-0)] px-4">
      ...
      <div className="relative w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white font-[family-name:var(--font-source-serif)]">Welcome back</h1>
          <p className="text-sm text-[var(--text-secondary)] mt-1">Sign in to access your dashboard</p>
        </div>
