...
const TREEMAP_TEXT: React.CSSProperties = { fill: "#ffffff", color: "#ffffff" };
const TREEMAP_TEXT_MONO: React.CSSProperties = { fill: "#ffffff", color: "#ffffff", fontFamily: "ui-monospace, monospace" };
